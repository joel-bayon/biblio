...
public class TestBibliotheque {
	...
	static BeanFactory factory = new AnnotationConfigApplicationContext(BiblioConfig.class);

	LivreDao livreDao = factory.getBean(LivreDao.class);

	AdherentDao adherentDao = factory.getBean(AdherentDao.class);
	EmpruntDao empruntDao = factory.getBean(EmpruntDao.class);
	Bibliotheque bibliotheque = factory.getBean(Bibliotheque.class);
	SessionFactory sf = factory.getBean(SessionFactory.class);
